...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampProps) => {
  return (
    <div className={`h-full w-gfull min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-xl 2xl:rounded-5xl`}>
...
const Camp = () => {
  return (
    <section className='2xl:max-container relative flex flex-col py-10 lg:py-20 lg:mb-10 xl:mb-20'>
      <div className="hide-scroll flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 max-w-[500px] lx:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
